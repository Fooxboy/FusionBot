...
namespace Fooxboy.WarOfTheWordGame.Commands
{
    public class StoreCommand : IFusionCommand
    {
        ...
        { 
            ...
            keyboardBuilder.AddButton("Танки", new PayloadBuilder("store", new List<object>() { "tanks" }), KeyboardButtonColor.Primary);
            keyboardBuilder.AddLine();
            keyboardBuilder.AddButton("Корабли", new PayloadBuilder("store", new List<object>() { "ships" }), KeyboardButtonColor.Primary);
            keyboardBuilder.AddLine();
            keyboardBuilder.AddButton("Самолеты", new PayloadBuilder("store", new List<object>() { "aircraft" }), KeyboardButtonColor.Primary);
            keyboardBuilder.AddLine();
            keyboardBuilder.AddButton("Скины", new PayloadBuilder("store", new List<object>() { "skins" }), KeyboardButtonColor.Primary);
            keyboardBuilder.AddLine();
            keyboardBuilder.AddButton("ДЕНЬГИ", new PayloadBuilder("store", new List<object>() { "donate" }), KeyboardButtonColor.Primary);
